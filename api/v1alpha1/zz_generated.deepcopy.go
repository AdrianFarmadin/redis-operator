...
func (in *RedisSpec) DeepCopyInto(out *RedisSpec) {
	*out = *in
	...
	if in.SysctlImage != nil {
		in, out := &in.SysctlImage, &out.SysctlImage
		*out = new(ImageOverride)
		(*in).DeepCopyInto(*out)
	}
	if in.VolumePermissionsImage != nil {
		in, out := &in.VolumePermissionsImage, &out.VolumePermissionsImage
		*out = new(ImageOverride)
		(*in).DeepCopyInto(*out)
	}
	if in.KubectlImage != nil {
		in, out := &in.KubectlImage, &out.KubectlImage
		*out = new(ImageOverride)
		(*in).DeepCopyInto(*out)
	}
	if in.OsShellImage != nil {
		in, out := &in.OsShellImage, &out.OsShellImage
		*out = new(ImageOverride)
		(*in).DeepCopyInto(*out)
	}
}
